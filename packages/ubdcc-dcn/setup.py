...
setup(
    ...
    license='MIT',
    install_requires=['ubdcc-shared-modules==0.4.0',
    ...
    ext_modules=cythonize(['ubdcc_dcn/__init__.py',
                           'ubdcc_dcn/RestEndpoints.py',
                           'ubdcc_dcn/DepthCacheNode.py'],
                          compiler_directives={'language_level': "3"}),
    python_requires='>=3.9.0',
    package_data={'': ['ubdcc_dcn/*.so']},
    exclude_package_data={'': ['ubdcc_dcn/*.py']},
    classifiers=[
