...
----------------------------------------------------------------------
ubdcc-mgmt       ubdcc-mgmt           42080    running    0.3.2
ubdcc-restapi    TDMKiCnT6jZ39N       42081    running    0.3.2
ubdcc-dcn        g3HcyluSZ5qWarm      42082    running    0.3.2
ubdcc-dcn        gpU3hkiU9Ei          42083    running    0.3.2
ubdcc-dcn        tDuu9mOXrt445XU      42084    running    0.3.2
ubdcc-dcn        xg6RZRf1APErfh1      42085    running    0.3.2
...
``` 
helm install ubdcc ubdcc/ubdcc --version 0.3.2
```
